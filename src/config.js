...
module.exports = {
  ...
  jobs: [
    {
      ...
      company: 'Claire Automotive Support',
      location: 'Ede, Netherlands',
      range: 'May 2022 - Present',
      url: 'https://www.claireautomotive.com/',
      tasks: [
        'Responsible for integrations with third parties, DMS and API implementations',
        'Manages day-to-day operations within a sprint to make sure members are on track',
        'Overtake development from the CTO as they transition to more administrative tasks',
        'Maintaining GCP infrastructure',
        'Create extensive and detailed refinements for backend tasks',
      ],
    },
    {
      id: 2,
  ...
  featured: [
    ...
    { 
      ...
      title: "Python Wrapper for a mobile game API", 
      tech: [], 
    ...
    { 
      ...
      title: "Python Wrapper for the Discord Interactions API", 
      tech: [], 
      github: "https://github.com/SilicalNZ/DiscordInterpythons", 
      cover: "", 
      cta: "", 
